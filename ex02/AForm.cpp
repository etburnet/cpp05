...
/*   Updated: 2025/03/26 16:06:41 by eburnet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	os << other.getName() << " need grade: " << other.getGradeSign() << " to be signed & grade: " << other.getGradeExec() << " to be exec, is it signed: " << other.getIsSigned() << std::endl;
	return os; 
}
